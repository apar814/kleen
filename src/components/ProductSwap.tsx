...
const ProductSwap: React.FC<ProductSwapProps> = ({ 
  ...
  return (
    <div className={cn("relative", className)}>
      <div className="relative overflow-hidden rounded-lg shadow-kleen-card" style={{ minHeight: '300px' }}>
        <div 
      ...
      >
        <ArrowRight className={cn(
          "w-5 h-5 text-kleen-mint transition-transform duration-300",
          showAlternative ? "rotate-180" : ""
        )} />
      </button>
      
      <div className="mt-4 flex justify-center items-center">
        <div className="text-center bg-kleen-mint/10 px-4 py-2 rounded-lg">
          ...
          {showAlternative && scoreDifference > 0 && (
            <div className="text-xs text-kleen-mint mt-1">
